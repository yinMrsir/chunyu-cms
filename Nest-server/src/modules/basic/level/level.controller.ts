...
import { ReqCreateLevelDto, ReqListLevelDto, ReqUpdateLevelDto } from './dto/req-level.dto';
...
export class LevelController {
  ...
  async create(
    ...
    const level = await this.levelService.findOne({ countryId: createLevelDto.countryId, level: createLevelDto.level });
