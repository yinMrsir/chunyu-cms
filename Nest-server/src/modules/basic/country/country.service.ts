...
export class CountryService {
  ...
  update(reqUpdateCountryDto: ReqUpdateCountryDto) {
    return this.countryRepository.update(reqUpdateCountryDto.id, reqUpdateCountryDto);
  }
  ...
  levels() {
    return this.countryRepository
      ...
      .leftJoinAndMapMany('country.children', Level, 'level', 'country.id = level.countryId')
      .select('country.id')
